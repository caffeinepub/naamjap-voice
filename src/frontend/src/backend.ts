...
import type { ChantSession as _ChantSession, Streak as _Streak, SyncState as _SyncState, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addChantSession(arg0: ChantSession): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addChantSession(to_candid_ChantSession_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMantras(): Promise<Array<Mantra>> {
        if (this.processError) {
            try {
    ...
    async getSessionSummaries(): Promise<Array<ChantSession>> {
        if (this.processError) {
            try {
    ...
    async getStreaks(): Promise<Array<Streak>> {
        if (this.processError) {
            try {
    ...
    async getSyncState(): Promise<SyncState | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSyncState();
    ...
    async syncDailyChantTotals(arg0: Array<DailyChantTotal>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.syncDailyChantTotals(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSyncState(arg0: SyncState): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSyncState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ChantSession_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ChantSession): ChantSession {
    return from_candid_record_n9(_uploadFile, _downloadFile, value);
}
function from_candid_Streak_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Streak): Streak {
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SyncState]): SyncState | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        mantra: value.mantra,
        durationMillis: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.durationMillis))
    };
}
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Streak>): Array<Streak> {
    return value.map((x)=>from_candid_Streak_n12(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ChantSession>): Array<ChantSession> {
    return value.map((x)=>from_candid_ChantSession_n8(_uploadFile, _downloadFile, x));
}
function to_candid_ChantSession_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ChantSession): _ChantSession {
...
function to_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        timestamp: value.timestamp,
        mantra: value.mantra,
        durationMillis: value.durationMillis ? candid_some(value.durationMillis) : candid_none()
    };
}
